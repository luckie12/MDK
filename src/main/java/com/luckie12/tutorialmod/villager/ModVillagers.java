package com.luckie12.tutorialmod.villager;
...
public class ModVillagers {
    ...
    public static final RegistryObject<VillagerProfession> JUMP_MASTER = VILLAGER_PROFESSIONS.register("jumpy_master",
            () -> new VillagerProfession("jumpy_master",
    ...
    public static void registerPOIs(){
        ...
        } catch(IllegalAccessError | IllegalAccessException | InvocationTargetException exeption){
